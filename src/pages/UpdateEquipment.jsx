...
export default function UpdateEquipment() {
    ...
    const { _id, itemName, photo, category, price, rating, customization, process, stock, description, email, name } = equipment;
    ...
    const handleUpdateEquipment = (e) => {
        ...
        const updatedEquipment = { itemName, photo, category, price, rating, customization, process, stock, description, email, name };
